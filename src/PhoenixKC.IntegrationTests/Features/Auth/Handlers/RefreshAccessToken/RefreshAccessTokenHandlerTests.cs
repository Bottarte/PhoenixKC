...
using PhoenixKC.WebAPI.Features.Auth.Extensions;
...
namespace PhoenixKC.IntegrationTests.Features.Auth.Handlers.RefreshAccessToken;

public sealed class RefreshAccessTokenHandlerTests(AppFixture thisApp)
{
    [Fact]

...
{
    private UpdateExampleCommandValidator Validator { get; } = new();
    ...
    public void Validator_ShouldNotHaveAnyValidationErrors_WhenDtoIsValid()
    {
        ...
        UpdateExampleCommand command = new(dto);

        //Act
        TestValidationResult<UpdateExampleCommand> result = Validator.TestValidate(command);
